...
% --- TODO: replace the names, institution and date before presenting -------
...
\begin{frame}{The brief}
  ...
  They need \alert{the enclosed area} --- that is what sets how many panels
  the site can hold.
...
\begin{frame}{What the surveyor actually recorded}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \begin{block}{Field notes --- station O}
        \small
        \begin{tabular}{@{}ll@{}}
    ...
    \begin{column}{0.48\textwidth}
      ...
      protractor. \alert{So the included angle has to be derived.}
    \end{column}
  \end{columns}
  \vfill
  \begin{center}
...
\begin{frame}{Now it is a standard SAS triangle}
  \begin{columns}[T]
    \begin{column}{0.44\textwidth}
      ...
      \end{block}
      \small
      The angle sits \alert{between} the two known sides --- exactly the SAS
      pattern.
      \medskip
