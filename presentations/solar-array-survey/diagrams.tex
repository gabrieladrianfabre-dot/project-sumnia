...
\begin{tikzpicture}[scale=1]
  ...
  % north arrow, kept clear of the parapet line at y = 5.42
  \begin{scope}[shift={(0.85,3.35)}]
    \draw[figmuted, line width=0.9pt, -{Stealth[length=5pt]}] (0,0) -- (0,1.0);
    \node[dim, above=1pt] at (0,1.0) {N};
  \end{scope}
